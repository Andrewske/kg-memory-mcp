  ...
  entityEntity: [
    {
      ...
      source_context: 'Professional role identification'
    },
    {
      subject: 'John Smith',
      predicate: 'works at',
      ...
      triple_type: 'ENTITY_ENTITY',
      source_context: 'Employment relationship'
    },
    {
      subject: 'Tech Corp',
      ...
      confidence: 0.85,
      semantic_content: 'Tech Corp is based in San Francisco',
      triple_type: 'ENTITY_ENTITY',
      source_context: 'Company location'
    }
  ],
  ...
  entityEvent: [
    {
      ...
      confidence: 0.8,
      semantic_content: 'John Smith participated in the product launch event',
      triple_type: 'ENTITY_EVENT',
      source_context: 'Event participation'
    },
    {
      subject: 'Tech Corp',
      predicate: 'hosted',
      object: 'product launch event',
      confidence: 0.9,
      semantic_content: 'Tech Corp hosted the product launch event',
      triple_type: 'ENTITY_EVENT',
      source_context: 'Event organization'
    }
  ],
  ...
  eventEvent: [
    {
      ...
      object: 'product launch event',
      confidence: 0.85,
      semantic_content: 'Product development preceded the product launch event',
      triple_type: 'EVENT_EVENT',
      source_context: 'Temporal sequence'
    },
    {
      ...
      confidence: 0.75,
      semantic_content: 'The product launch event caused a stock price increase',
      triple_type: 'EVENT_EVENT',
      source_context: 'Causal relationship'
    }
  ],
  ...
  emotionalContext: [
    {
      ...
      confidence: 0.8,
      semantic_content: 'John Smith feels excited about AI projects',
      triple_type: 'EMOTIONAL_CONTEXT',
      source_context: 'Emotional state regarding work'
    },
    {
      ...
      confidence: 0.85,
      semantic_content: 'Sarah Johnson feels passionate about technology solutions',
      triple_type: 'EMOTIONAL_CONTEXT',
      source_context: 'Professional motivation'
    }
  ]
};
...
export const sampleConcepts: Concept[] = [
  ...
  },
  {
    ...
    abstraction_level: 'HIGH',
    confidence: new (require('@prisma/client/runtime/library').Decimal)(0.93),
    source: 'test-source',
    source_type: 'test',
    extracted_at: new Date()
  },
  {
    ...
    abstraction_level: 'HIGH',
    confidence: new (require('@prisma/client/runtime/library').Decimal)(0.91),
    source: 'test-source',
    source_type: 'test',
    extracted_at: new Date()
  },
  ...
  // Medium-level concepts
  {
    ...
    confidence: new (require('@prisma/client/runtime/library').Decimal)(0.97),
    source: 'test-source',
    source_type: 'test',
    extracted_at: new Date()
  },
  {
    ...
    abstraction_level: 'MEDIUM',
    confidence: new (require('@prisma/client/runtime/library').Decimal)(0.96),
    source: 'test-source',
    source_type: 'test',
    extracted_at: new Date()
  },
  {
    ...
    abstraction_level: 'MEDIUM',
    confidence: new (require('@prisma/client/runtime/library').Decimal)(0.94),
    source: 'test-source',
    source_type: 'test',
    extracted_at: new Date()
  },
  ...
  // Low-level concepts
  {
    ...
    confidence: new (require('@prisma/client/runtime/library').Decimal)(0.98),
    source: 'test-source',
    source_type: 'test',
    extracted_at: new Date()
  },
  {
    ...
    abstraction_level: 'LOW',
    confidence: new (require('@prisma/client/runtime/library').Decimal)(0.92),
    source: 'test-source',
    source_type: 'test',
    extracted_at: new Date()
  },
