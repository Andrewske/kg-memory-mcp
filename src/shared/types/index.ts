...
export interface KnowledgeTriple {
	...
	conversation_date?: string; // when conversation happened (ISO format)
...
export interface ConceptualizationRelationship {
	...
	source_type: "entity" | "event" | "relation"; // Type of the source element
	...
	// Metadata
	source: string; // The actual identifier (thread_12345, filename.txt, etc.)
	data_source_type: string; // "thread", "file", "manual", "api", etc.
...
// Configuration types - simplified for stateless architecture
